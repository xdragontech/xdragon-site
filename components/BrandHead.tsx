...
export default function BrandHead({ title, description }: BrandHeadProps) {
  ...
  return (
    <Head>
      ...
      {includeSiteChrome ? <link rel="icon" type="image/png" href="/favicon_symbol.png?v=2" /> : null}
      {includeSiteChrome ? <link rel="shortcut icon" href="/favicon_symbol.png?v=2" /> : null}
