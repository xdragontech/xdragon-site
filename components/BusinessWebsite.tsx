...
/**
 * Font note:
 * We intentionally load Orbitron via CSS @import so this component works in both:
 * - Next.js (Pages Router)
 * - sandbox previews where `next/font/google` may be unavailable
 */
...
export default function BusinessWebsite() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 text-neutral-900">
      {/* Load Orbitron Bold (700) for the word “Dragon” */}
      <style>{`
